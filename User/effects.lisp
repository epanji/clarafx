...
(define-effect (shaking-each-syllables var)
  (modifier 'pos :arg1 (point-x1 var) :arg2 (point-y2 var))
  (modifier 'origin :arg1 (- (point-x2 var) (floor (width var) 2))
                    :arg2 (- (point-y2 var) (floor (height var) 2)))
...
(define-effect (dropping-each-syllables var)
  (modifier 'fad :arg1 250 :arg2 0)
  (modifier 'move :arg1 (point-x1 var)
                  :arg2 (- (point-y2 var) (* 2/3 (height var)))
                  :arg3 (point-x1 var)
                  :arg4 (point-y2 var)
                  :arg5 0
                  :arg6 500))
...
(define-effect (rotate-ccw-each-syllables var)
  (modifier 'pos :arg1 (point-x1 var) :arg2 (point-y2 var))
  (modifier 'origin :arg1 (- (point-x2 var) (truncate (width var) 2))
                    :arg2 (- (point-y2 var) (truncate (height var) 2)))
