...
(test strip-package-from-symbol
  (let ((0str0 "symbol")
        ...
        (0str3 "package:::symbol")
        (0str4 "incorrect:package:symbol")
        (1str0 "(list :key1 'symbol :key2 value)")
        (1str1 "(list :key1 'pkg:symbol :key2 pkg:value)")
        (1str2 "(list :key1 'pkg::symbol :key2 pkg::value)")
        (2str0 "\"package:symbol\\\"package::symbol\" 'symbol")
        (2str1 "\"package:symbol\\\"package::symbol\" 'package:symbol")
        (2str2 "\"package:symbol\\\"package::symbol\" 'package::symbol")
...
(test split-element-drawing-commands
  (let ((edcs (list #\m -5.4 4.3 #\l 3.2 -2.1 1.0 -0.1 1.2 -2.3 3.4 -4.5))
        (str1 "m -5.4 4.3 l 3.2 -2.1 1.0 -0.1 1.2 -2.3 3.4 -4.5")
        (str2 "m-5.4 4.3l3.2-2.1 1.0-.1 1.2-2.3 3.4-4.5")
        (str3 "M-5.4 4.3L3.2-2.1 1.0-.1 1.2-2.3 3.4-4.5")
        (str4 "M-5.4J4.3l3.2-2.1j1.0-.1U1.2-2.3u3.4-4.5"))
    (flet ((split (str)
...
(test svg-data-to-element-drawing-commands
  (let ((edcs (list #\m -5.4 4.3 #\b 3.2 -2.1 1.0 -0.1 1.2 -2.3))
        (str1 "m -5.4 4.3 c 3.2 -2.1 1.0 -0.1 1.2 -2.3")
        (str2 "m-5.4 4.3c3.2-2.1 1.0-.1 1.2-2.3")
        (str3 "M-5.4 4.3C3.2-2.1 1.0-.1 1.2-2.3")
        (str4 "M-5.4J4.3c3.2-2.1j1.0-.1U1.2-2.3"))
    (flet ((convert (str)
