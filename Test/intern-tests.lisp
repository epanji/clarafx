...
(test strip-package-from-symbol
  (let ((0str0 "symbol")
        ...
        (4str0 (format nil "#|~%p:s #| p::s~%\"p:s~%; p:s~%|#~%p:s~%|#~%'symbol #|# p:s #|"))
        (4str1 (format nil "#|~%p:s #| p::s~%\"p:s~%; p:s~%|#~%p:s~%|#~%'package:symbol #|# p:s #|"))
        (4str2 (format nil "#|~%p:s #| p::s~%\"p:s~%; p:s~%|#~%p:s~%|#~%'package::symbol #|# p:s #|"))
